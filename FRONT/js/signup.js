document.addEventListener("DOMContentLoaded", 
    ...
    function(e) {
        ...
        usernameInput.addEventListener('input', () => validateInput(usernameInput, usernameErrorDiv, /^[a-zA-Z0-9]{4,16}$/, "유효한 사용자 아이디를 입력해주세요(4자 이상, 16자 이하의 영문과 특수문자만)"));
        passwordInput.addEventListener('input', () => validateInput(passwordInput, passwordErrorDiv, /^[a-zA-Z0-9!@#$%^&*()_+]{4,}$/, "유효한 비밀번호를 입력해주세요(4자 이상의 영문, 특수문자, 숫자)"));
        ...
        form.addEventListener('submit', function(event) {
            const isUsernameValid = validateInput(usernameInput, usernameErrorDiv, /^[a-zA-Z0-9]{4,16}$/, "유효한 사용자 아이디를 입력해주세요(4자 이상, 16자 이하의 영문과 특수문자만)");
            const isPasswordValid = validateInput(passwordInput, passwordErrorDiv, /^[a-zA-Z0-9!@#$%^&*()_+]{4,}$/, "유효한 비밀번호를 입력해주세요(4자 이상의 영문, 특수문자, 숫자)");
